...
namespace KRAVANH\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use KRAVANH\Models\LabelTranslate;
use File;
...
class LanguageTranslationController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('kravanh::languages', compact('languages','columns','columnsCount'));
    ...
    */
    public function store(Request $request)
    {
        ...
        return redirect()->route('voyager.labellanguages');
    }
